...
public class CardRules
{
	...
	static final byte ROYALIST = 9;
    static final byte STRAIGHTENS = 8;
    static final byte FORESKIN = 7;
    static final byte FALLOUT = 6;
    static final byte FLUSH 			= 5;
    static final byte STRAIGHT		= 4;
    static final byte THREEFOLD = 3;
    static final byte TAPIR = 2;
    static final byte PAIR			= 1;
    static final byte NOTHING			= 0;
    static final byte FOLD			=-1;
    static final byte GAMEST =-2;
    static final byte SHOWCASE =-3;
